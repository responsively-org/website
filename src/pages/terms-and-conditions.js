          ...
          <div className="row justify-content-center mb-5">
            <div className="col-xl-9 col-lg-8 col-md-9">
              ...
              <p>
                ...
                conditions in full. Do not continue to use Responsively App's
              ...
              <h2>Cookies</h2>
              <p>
                We employ the use of cookies. By using Responsively App's
                website you consent to the use of cookies in accordance with
                Responsively App's privacy policy.
              </p>
              <p>
              ...
              <h2>License</h2>
              <p>
                Unless otherwise stated, Responsively App and/or it's licensors
                own the intellectual property rights for all material on
                Responsively App. All intellectual property rights are reserved.
                You may view and/or print pages from https://responsively.app
              ...
              <p>
                Redistribute content from Responsively App (unless content is
              ...
              <p>
                ...
                of Responsively App; and (d) where the link is in the context of
              ...
              <p>
                No use of Responsively App's logo or other artwork will be
