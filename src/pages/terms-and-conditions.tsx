...
export default function TermsAndConditions() {
  return (
    <>
      <Head>
        <title>Terms and Conditions | Responsively App</title>
      </Head>

      <Header />
      <BlurBG bgColor="none" bubbleType="2" />
      <Container className="relative mb-20">
        ...
        <div className="prose">
          <p>
            These terms and conditions outline the rules and regulations for the use of Responsively
            App's Website, the desktop app and the browser extensions.
          </p>{' '}
          <br />
          <p>
            By accessing this website we assume you accept these terms and conditions in full. Do
            not continue to use Responsively App's website. if you do not accept all of the terms
          ...
          <p>
            ...
            services/products, in accordance with and subject to, prevailing law of . Any use of the
            above terminology or other words in the singular, plural, capitalisation and/or he/she
            or they, are taken as interchangeable and therefore as referring to same.
          </p>
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By using Responsively App's website you consent to the use
            of cookies in accordance with Responsively App's privacy policy.
          </p>
          <p>
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, Responsively App and/or it's licensors own the intellectual
            property rights for all material on Responsively App. All intellectual property rights
            are reserved. You may view and/or print pages from https://responsively.app for your own
          ...
          <p>
            Redistribute content from Responsively App (unless content is specifically made for
            redistribution).
          </p>
          ...
          <p>
            ...
            the visibility associated with the hyperlink outweighs the absence of Responsively App;
            and (d) where the link is in the context of general resource information or is otherwise
          ...
          <p>
            ...
            linking to our website, you must notify us by raising an issue at
            https://github.com/responsively-org/responsively-app/issues. Please include your name,
            your organization name, contact information (such as a phone number and/or e-mail
          ...
          <p>
            No use of Responsively App's logo or other artwork will be allowed for linking absent a
          ...
          <p>
            If you have any questions about this Privacy Policy, please contact us by raising an
            issue at https://github.com/responsively-org/responsively-app/issues.
          </p>
        </div>
      </Container>
      <Footer />
